...
import loginImg from '../../img/loginpic.jpg';
...
function Login() {
    ...
    return (
        <Container style={{marginTop: '100px', background: "#d0d2d8"}} className='p-4 text-center '>
            <Row>
                <Col lg={4} md={6} sm={12} className="">
                    <form onSubmit={handleSubmit} className='p-3'>
                        ...
                        <input type='submit' className='btn btn-custom form-control mt-2' value={newUser ? 'Create an account' : 'Login'} />
                        <br /><br />
                        <h6>
                            {newUser
                ...
                {newUser ? 'Login' : 'Create an account'}
                        ...
                        <hr />
                        <Button className="btn-custom" variant='secondary btn-block' onClick={handleGoogleSignIn}> <FontAwesomeIcon icon={faGoogle} /> Continue with Google </Button>
                    </form>
                </Col>
