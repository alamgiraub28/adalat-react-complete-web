...
const Admin = () => {
    ...
    useEffect(()=>{
        fetch(`https://agile-springs-09657.herokuapp.com/admin/${loggedInUser.email}`)
    .then(res => res.json())
        ...
        return (
            <>
                <Navbar  expand="lg" fixed="top" className="mb-5 navBg" variant="light">
                    <Link to="/"><span className="admin-title"><img src={logo} alt=""/></span></Link>
                    ...
                    <div className={state.sideNavClass}>
                        ...
                        <NavLink><Link className="NavItem" to="/makeAdmin"> <FontAwesomeIcon icon={faUser} /> Create Admin</Link></NavLink>
